...
class UdfCodeModel(BaseModel):
    ...
    language: str = pydSchema(..., description="The language of UDF code")
    source: str = pydSchema(..., description="The UDF source code as a string")
...
class ErrorResponseModel(BaseModel):
    ...
    message: str = pydSchema(..., description="The error message")

    traceback: str = pydSchema(None, description="The optional python traceback")
