...
class FeatureCollectionTileModel(BaseModel):
    ...
    id: str = pydSchema(..., description="The identifier of this vector tile.", examples=[{"id": "test_data"}])

    data: Dict = pydSchema(..., description="A GeoJSON FeatureCollection.",
                           examples=[
                               {"data": {"features": [{"id": "0", "type": "Feature", "properties": {"a": 1, "b": "a"},
                                                       "geometry": {"coordinates": [24.0, 50.0], "type": "Point"}},
                                                      {"id": "1", "type": "Feature", "properties": {"a": 2, "b": "b"},
    ...
    start_time: List[str] = pydSchema(None, description="The array that contains that start time values for "
    ...
    end_time: List[str] = pydSchema(None,
